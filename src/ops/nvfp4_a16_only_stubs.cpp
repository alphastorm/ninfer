// NVFP4 W4A4 execution needs Blackwell tensor cores. On Ada (sm_89) and Ampere (sm_86) builds
// the W4A4 kernels are excluded and these launchers stand in for them: the NVFP4 artifacts still
// load and run through the A16 decode and small-T paths, and any plan that reaches a W4A4
// launcher is a policy error, reported rather than silently degraded.
