...
struct Package {
    ...
    using ProtectedPrivateOwner      = qwen3_6::ProtectedPrivateOwner<detail::Variant>;
    using ProtectedSharedOwner       = qwen3_6::ProtectedSharedOwner<detail::Variant>;
    ...
    using ReplicaTransitionOption    = qwen3_6::ReplicaTransitionOption;
    using ReplicaTransitionResult    = qwen3_6::ReplicaTransitionResult;
