...
// MSVC emits no definition for an explicitly defaulted specialization of a move constructor
// (the destructor and assignment specializations are fine), so the three are spelled out.
template <>
