...
public:
    ...
    // time held P1 and 25% did not (omp-ninfer EXP-061); 35% leaves a margin and draws about
    // 70 W above idle on an RTX 5090 (EXP-062). A short period keeps any spin overlapping an
    // admitted request brief.
