...
nlohmann::json production_fingerprint(const BuildInfo& build,
    ...
    memory.kv_capacity                       = 131072;
    memory.kv_capacity_page_groups           = 512;
...
int test_production_manager_restart_and_identity_isolation() {
    ...
    failures += check(runtime.at("identity").at("model_id") == "qwen3.8-27b" &&
                          ...
                          runtime.at("engine").at("speculative_backend") ==
                              static_cast<int>(SpeculativeBackend::None) &&
                          runtime.at("target_layout").at("kv_capacity_tokens") == 131072 &&
    ...
    architecture_drift.cuda_architecture = "86";
