...
int main() {
    ...
    int failures = 0;
    failures += ninfer::test::arm("NVFP4 linear_add [5120,6144]", [] { return run_shape(5120, 6144, 811U); });
    failures += ninfer::test::arm("NVFP4 linear_add [5120,17408]", [] { return run_shape(5120, 17408, 821U); });
