...
class WindowsReleaseContractTests(unittest.TestCase):
    ...
    def test_pinned_release_and_authenticated_c1_defaults(self) -> None:
        ...
        self.assertEqual(spec["release_id"], "qwen38-3090-omp-v0.2.4-beta.1")
        self.assertEqual(spec["deployment_profile"], "qwen38-3090-omp-v0.2.4-beta.1-c1")
        self.assertEqual(spec["build_profile"], "omp-v0.2.4-rtx3090")
