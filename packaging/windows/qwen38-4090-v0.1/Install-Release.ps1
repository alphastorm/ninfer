...
try {
    ...
    if ([IO.Path]::GetFileName($package) -cne 'ninfer-4090-qwen38-v0.2.3-win-x64.zip') {
    ...
    try {
        ...
        if ([string]$manifest.release_version -cne '0.2.3' -or
            [string]$manifest.asset_filename -cne 'ninfer-4090-qwen38-v0.2.3-win-x64.zip') {
