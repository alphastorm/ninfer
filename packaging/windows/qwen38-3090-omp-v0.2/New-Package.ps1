...
$releaseId = 'qwen38-3090-omp-v0.2.0'
$releaseVersion = 'v0.2.0'
$deploymentProfile = 'qwen38-3090-omp-v0.2.0-c1'
$buildProfile = 'omp-v0.2.0-rtx3090'
...
try {
    ...
    foreach ($name in @('Install-Release.ps1', 'Control-Release.ps1', 'New-QualificationReceipt.ps1', 'SHA256SUMS.txt')) {
