...
$releaseId = 'qwen38-3090-omp-v0.2.1-beta.1'
$releaseVersion = 'v0.2.1-beta.1'
$deploymentProfile = 'qwen38-3090-omp-v0.2.1-beta.1-c1'
$buildProfile = 'omp-v0.2.1-rtx3090'
...
try {
    ...
    $buildReceipt = [ordered]@{
        ...
        later_external_beta_authority = [ordered]@{
            ...
            schema_version = 3
            public_receipt_path = 'docs/qualification/receipts/qwen3.8-27b-rtx-3090-v0.2.1-beta.1.json'
