...
function New-NInferQualificationReceipt {
    ...
    $releaseAssetsReceipt = [ordered]@{
        package = Get-NInferQualificationAsset $ReleaseAssets 'package' 'ninfer-rtx3090-omp-v0.2.5-beta.1-windows-x86_64-cuda13.3-rtx3090.tar.gz'
        source_archive = Get-NInferQualificationAsset $ReleaseAssets 'source_archive' 'ninfer-rtx3090-omp-v0.2.5-beta.1-source.tar.gz'
        spdx_sbom = Get-NInferQualificationAsset $ReleaseAssets 'spdx_sbom' 'ninfer-rtx3090-omp-v0.2.5-beta.1-windows-x86_64-cuda13.3-rtx3090.spdx.json'
