...
function Assert-InstallerArchitectureContract([object]$Spec, [object]$Config) {
    ...
    if ([string]$Spec.build_profile -cne 'omp-v0.2.2-rtx3090' -or
    ...
    if ([string]$Config.deployment_profile -cne 'qwen38-3090-omp-v0.2.2-beta.1-c1' -or
...
try {
    ...
    if ([IO.Path]::GetFileName($package) -cne 'ninfer-rtx3090-omp-v0.2.2-beta.1-windows-x86_64-cuda13.3-rtx3090.tar.gz') {
