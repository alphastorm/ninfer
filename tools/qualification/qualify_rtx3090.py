...
RELEASE_ID = "qwen38-3090-omp-v0.2.4-beta.1"
PACKAGE_NAME = (
    "ninfer-rtx3090-omp-v0.2.4-beta.1-"
    "windows-x86_64-cuda13.3-rtx3090.tar.gz"
)
SOURCE_NAME = "ninfer-rtx3090-omp-v0.2.4-beta.1-source.tar.gz"
SPDX_NAME = (
    "ninfer-rtx3090-omp-v0.2.4-beta.1-"
