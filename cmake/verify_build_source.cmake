...
if(NOT NINFER_SOURCE_DIRTY_MODE STREQUAL "auto" AND
   NOT NINFER_SOURCE_DIRTY_MODE STREQUAL "ON" AND
   NOT NINFER_SOURCE_DIRTY_MODE STREQUAL "OFF")
  message(FATAL_ERROR "NINFER_SOURCE_DIRTY_MODE must be auto, ON, or OFF")
endif()

# A source archive without Git metadata was already bound and checked by the lifecycle tool before
# configuration. A live Git worktree must still match the identity baked at configure time whenever
# the compiler runs; otherwise an incremental build could label edited source as clean.
...
if(NOT NINFER_CONFIGURED_PATCH_STACK_SHA STREQUAL "unknown" AND
  ...
  message(FATAL_ERROR
    "source commit changed since configure; rerun CMake before building")
endif()

if(NINFER_SOURCE_DIRTY_MODE STREQUAL "auto" OR
   NINFER_SOURCE_DIRTY_MODE STREQUAL "OFF")
  execute_process(
  ...
  if(NOT current_source_dirty STREQUAL NINFER_CONFIGURED_SOURCE_DIRTY)
    message(FATAL_ERROR
      "source dirty state changed since configure; rerun CMake before building")
  endif()
endif()
